...
assert.match(main, /recordInventorySnapshotChanges\(previous,snapshotInventory\(\),'photo_remove'\)/);
assert.match(main, /recordInventorySnapshotChanges\(previous,snapshotInventory\(\),'photo_add'\)/);
