...
const imported = applyInventoryRows({}, [{ Bone_ID: 'left_femur', Presence: 'present', Individual_ID: 'IND-B', Weight_g: '88.2', Portion: 'shaft_mid', Taphonomy: 'raíces; erosión', Pathology: 'fractura' }], testBones);
