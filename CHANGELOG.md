...
- Los registros científicos pueden asociarse explícitamente a IDs de yacimiento, campaña, sector, contexto e individuo; la relación se persiste, deshace y exporta/importa.
...
- El estado de revisión de NISP/MNE/MNI queda expuesto como `current`, `stale` o `none`, y los valores obsoletos no se presentan como revisados.
- La prueba E2E cubre el ciclo completo de guardar una revisión manual, modificar el inventario y mostrar el aviso de revisión obsoleta.
