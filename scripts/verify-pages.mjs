...
const DEFAULT_PAGES_URL = 'https://jj-martinez-garcia.github.io/ArchaeOsteo/';
const target = process.argv.slice(2).find(argument => argument !== '--') || process.env.OSTEO3D_PAGES_URL || DEFAULT_PAGES_URL;
