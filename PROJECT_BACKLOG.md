...
| 39 | MNE | Cálculo automático provisional y revisión manual con entero, justificación y firma del inventario filtrado; conserva límites sobre porciones/solapamiento, marca una revisión antigua como obsoleta tras cambiar los datos y exige revisión especializada. |
| 40 | MNI | Cálculo automático provisional y revisión manual con entero, justificación y firma del inventario filtrado; no cuenta fragmentos como individuos, marca una revisión antigua como obsoleta tras cambiar los datos y conserva los límites de asociación. |
