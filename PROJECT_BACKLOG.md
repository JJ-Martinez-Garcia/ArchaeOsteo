...
Actualizado: 2026-09-10. Fuente: los 119 apartados del encargo original.
...
| 74 | INFORME AUTOMÁTICO | Informe con fuentes/métodos/límites, jerarquía normalizada, observaciones de componentes inmaduros, fotos elegidas, mapa esquelético esquemático y reglas de impresión A4 para evitar cortes; queda cartografía anatómica profesional y maquetación PDF avanzada. |
| 75 | EXPORTACIÓN | JSON conserva la copia completa, incluida la vista de cámara, componentes inmaduros y asociaciones jerárquicas por registro; CSV contiene el inventario tabular, las porciones independientes, asociaciones y su registro inmaduro JSON; XLSX incluye e importa inventario, contexto, jerarquía, asociaciones, odontogramas, fragmentos, desarrollo, osteometría, landmarks, calibraciones, referencias, revisión, cambios y metadatos de fotos/modelos. Falta verificar round-trip con casos reales y decidir un formato tabular para binarios. |
...
| 88 | OPTIMIZACIÓN 3D | Liberación de geometrías/materiales, carga concurrente limitada en móviles/poca memoria, diagnóstico visible de mallas/triángulos/origen con advertencia orientativa y selector persistente de calidad de renderizado (automática/baja/alta). Quedan LOD, presupuestos formales y medición en móviles reales. |
...
| 95 | LICENCIAS DE MODELOS 3D | 537 GLB propios y 179 externos documentados; las fuentes, autoría, licencia, URL de términos, fecha de consulta y advertencia didáctica están incorporadas y validadas. Sigue pendiente la auditoría especializada de cada licencia/fuente externa y validar anatómicamente los GLB procedurales antes de cualquier uso científico. |
