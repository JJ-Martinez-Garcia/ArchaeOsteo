...
| 94 | MODULARIDAD | Los exportadores XLSX/pesos, los controles de fotografías, los filtros extendidos y el reset de nuevo proyecto ya no dependen de temporizadores de carga arbitrarios; quedan los temporizadores de UI restantes y la separación completa de dependencias cruzadas. |
