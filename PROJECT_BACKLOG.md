...
| 75 | EXPORTACIÓN | JSON conserva la copia completa, incluida la vista de cámara y componentes inmaduros; CSV contiene el inventario tabular y su registro inmaduro JSON; XLSX incluye e importa inventario, contexto, jerarquía, odontogramas, fragmentos, desarrollo, osteometría, landmarks, calibraciones, referencias, revisión, cambios y metadatos de fotos/modelos. Falta verificar round-trip con casos reales y decidir un formato tabular para binarios. |
