...
| 76 | CSV/XLSX | Esquema estable y códigos canónicos, comillas/saltos de línea, trazabilidad de fuentes/método/límites en CSV y protección de texto introducido frente a fórmulas al abrir CSV/XLSX. La cobertura de hojas auxiliares y una hoja `Esquema` autodocumentada están implementadas; queda auditoría con casos reales. |
