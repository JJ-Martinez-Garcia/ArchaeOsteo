...
| 38 | NISP | `Specimen_ID` explícito por registro, cobertura de IDs únicos y alerta de conflictos individuo/contexto implementados; el automático agrupa el mismo espécimen por elemento y conserva el carácter provisional sin ID. Sigue pendiente un modelo de espécimen individual más rico y la validación arqueológica especializada. |
