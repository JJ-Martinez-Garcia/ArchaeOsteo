export const INVENTORY_SNAPSHOT_FIELDS = ['status', 'preservation', 'completeness', 'fragments', 'weights', 'weightUnits', 'portions', 'portionRecords', 'individuals', 'ue', 'taphonomy', 'pathology', 'taphonomyDetails', 'pathologyDetails', 'notes', 'locked', 'dental', 'deciduousDental', 'report', 'analysisReview', 'measurements', 'landmarks', 'calibrations', 'landmarkModelRefs', 'photos', 'indeterminateFragments'];
