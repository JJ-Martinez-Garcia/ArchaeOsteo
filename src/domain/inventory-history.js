export const INVENTORY_SNAPSHOT_FIELDS = ['status', 'preservation', 'completeness', 'fragments', 'weights', 'portions', 'individuals', 'ue', 'taphonomy', 'pathology', 'taphonomyDetails', 'pathologyDetails', 'notes', 'locked', 'dental', 'deciduousDental', 'report', 'measurements', 'landmarks', 'indeterminateFragments'];
