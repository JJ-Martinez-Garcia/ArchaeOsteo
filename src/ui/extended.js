...
export function initExtendedFeatures({ state, bones, saveLocal, selectBone, renderList, renderStats, downloadFile, listProjects, loadProject, commitInventoryEdit, applyProjectData, getModelManifest = () => null }) {
  ...
  document.querySelector('#record-panel-button').onclick = () => {
    ...
    const localizeScientificRecordUi = () => {
      ...
      const labels = { 'record-fragments': 'Fragments', 'record-weight': 'Weight', 'record-portion': 'Anatomical portion', 'record-individual': 'Individual', 'record-taphonomy': 'Taphonomy', 'record-pathology': 'Pathology / trauma', 'record-note': 'Scientific note', 'record-taphonomy-type': 'Type', 'record-taphonomy-description': 'Description', 'record-taphonomy-position': 'Position', 'record-taphonomy-extent': 'Extent', 'record-taphonomy-observations': 'Observations', 'record-pathology-type': 'State', 'record-pathology-description': 'Description', 'record-pathology-position': 'Position', 'record-pathology-extent': 'Extent', 'record-pathology-observations': 'Observations' };
  ...
  const sourcePanelMarkup = () => state.language === 'en'
    ? '<h3>Sources and licenses</h3><p>The adult male profile publishes 179 of 192 GLB elements. The remaining 13 markers are aggregate or indeterminate categories and are not anatomical meshes suitable for measurement or diagnosis.</p><p><code>skull.glb</code>: Vladimir Petkovic, Khronos glTF Sample Assets, CC0 1.0 Universal · <a href="https://creativecommons.org/public-domain/cc0/" target="_blank" rel="noopener noreferrer">CC0 legal text</a>.</p><p>Other 178 elements: Open3Dmodel contributors / Open Anatomy lineage, Open3Dmodel / AnatomyTOOL; web preparation by yamz8. Adaptations are distributed under <a href="./licenses/CC-BY-SA-4.0.txt" target="_blank" rel="noopener noreferrer">CC BY-SA 4.0</a> · <a href="https://creativecommons.org/licenses/by-sa/4.0/" target="_blank" rel="noopener noreferrer">official license</a>.</p><p>Adult female, infant and neonate: 179 original GLBs per profile (537 files), Osteo3D contributors, MIT, procedural-1.1.0 · <a href="https://opensource.org/license/mit/" target="_blank" rel="noopener noreferrer">official MIT license</a>. Didactic original models, without metric scale or anatomical validation; not scans.</p><p class="small-copy">Complete registry: <a href="./models/SOURCES.md" target="_blank" rel="noopener noreferrer">Model sources</a> · <a href="./LICENSE" target="_blank" rel="noopener noreferrer">Code license</a> · <a href="./THIRD_PARTY_LICENSES.md" target="_blank" rel="noopener noreferrer">Third-party licenses</a>.</p>'
    : '<h3>Fuentes y licencias</h3><p>El perfil adulto masculino publica 179 de 192 elementos GLB. Los 13 marcadores restantes son categorías agregadas o indeterminadas y no representan modelos anatómicos aptos para medición o diagnóstico.</p><p><code>skull.glb</code>: Vladimir Petkovic, Khronos glTF Sample Assets, CC0 1.0 Universal · <a href="https://creativecommons.org/public-domain/cc0/" target="_blank" rel="noopener noreferrer">texto legal CC0</a>.</p><p>Otros 178 elementos: Open3Dmodel contributors / Open Anatomy lineage, Open3Dmodel / AnatomyTOOL; preparación web por yamz8. Las adaptaciones se distribuyen bajo <a href="./licenses/CC-BY-SA-4.0.txt" target="_blank" rel="noopener noreferrer">CC BY-SA 4.0</a> · <a href="https://creativecommons.org/licenses/by-sa/4.0/" target="_blank" rel="noopener noreferrer">licencia oficial</a>.</p><p>Adulto femenino, infante y neonato: 179 GLB propios por perfil (537 archivos), Osteo3D contributors, MIT, procedural-1.1.0 · <a href="https://opensource.org/license/mit/" target="_blank" rel="noopener noreferrer">licencia MIT oficial</a>. Modelos didácticos originales, sin escala métrica ni validación anatómica; no son escaneos.</p><p class="small-copy">Registro completo: <a href="./models/SOURCES.md" target="_blank" rel="noopener noreferrer">Fuentes de modelos</a> · <a href="./LICENSE" target="_blank" rel="noopener noreferrer">Licencia del código</a> · <a href="./THIRD_PARTY_LICENSES.md" target="_blank" rel="noopener noreferrer">Licencias de terceros</a>.</p>';
