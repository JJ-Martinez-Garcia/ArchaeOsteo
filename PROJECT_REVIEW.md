...
| 74–78 | Informe imprimible/PDF del navegador con reglas A4 para paginación, JSON, CSV multilínea, XLSX e importación con previsualización existentes. CSV/XLSX protegen ahora texto introducido con prefijos de fórmula. XLSX incluye e importa hojas auxiliares de osteometría, landmarks, calibraciones, referencias, revisión, cambios y metadatos; siguen pendientes round-trip con casos reales, mapa esquelético y PDF de maquetación profesional. |
