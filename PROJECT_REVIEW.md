...
| 93–94, 108–109, 116 | Separación nueva del generador, análisis y cargador; preservación de IDs y datos. Los exportadores XLSX/pesos, los controles de fotografías, los filtros extendidos y el reset de nuevo proyecto se enlazan sin temporizadores de carga arbitrarios; el diagnóstico de capacidades se inicializa una sola vez y el gestor de proyectos usa una microtarea segura. Los ciclos periódicos de UI se omiten en segundo plano, pero `main.js` conserva deuda de modularidad y algunos temporizadores históricos. |
